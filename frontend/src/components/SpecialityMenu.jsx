...
const SpecialityMenu = () => {
  return (
    <div className='flex flex-col items-center gap-4 py-6 text-gray-800 mt-15' id='speciality'>
      ...
      <div className='flex sm:justify-center gap-4 pt-5 w-full overflow-scroll mt-5'>
