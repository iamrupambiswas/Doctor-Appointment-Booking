    ...
    <form onSubmit={onSubmitHandler} className='m-5 w-full'>
      ...
      <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
        ...
        <div>
          ...
          <textarea onChange={(e) => setAbout(e.target.value)} value={about} className='w-full border rounded px-3 py-2' placeholder='Write about yourself' rows={5} required />
        </div>

        <button type='submit' className='bg-primary hover:bg-primaryDark px-10 py-3 mt-4 text-white rounded-full'>Add doctor</button>
      </div>
    </form>
  )
}
